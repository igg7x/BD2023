...
CREATE TABLE `turno` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uix_turno` (`institucionorientacionid`,`sedeid`,`nombre`),
  KEY `sedeid` (`sedeid`),
  CONSTRAINT `turno_ibfk_1` FOREIGN KEY (`sedeid`) REFERENCES `sede` (`id`),
  CONSTRAINT `turno_ibfk_2` FOREIGN KEY (`institucionorientacionid`) REFERENCES `institucionorientacion` (`id`),
