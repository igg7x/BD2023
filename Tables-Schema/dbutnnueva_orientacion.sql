...
CREATE TABLE `orientacion` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uix_orientacion_nombre` (`nombre`)
...
INSERT INTO `orientacion` VALUES (4,'Ciencias Naturales'),(5,'Ciencias Sociales'),(6,'Economia'),(8,'Tecnica - Electricidad'),(12,'Tecnica - Electromecanica'),(9,'Tecnica - Electronica'),(10,'Tecnica - Informatica'),(11,'Tecnica - Mecanica'),(7,'Tecnica -Constricciones');
